...
@Component({
  ...
  //         <div>
  //           <h3 class="text-xl font-bold gold-gradient-text mb-4">The Jewel Beautiq</h3>
  ...
  //         <p class="text-luxury-silver text-sm">&copy; 2024 The Jewel Beautiq. All rights reserved.</p>
  //       </div>
  //     </div>
  //   </footer>
  // `
